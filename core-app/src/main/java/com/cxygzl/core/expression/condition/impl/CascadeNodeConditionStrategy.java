 ...
 */
@Component
public class CascadeNodeConditionStrategy implements NodeConditionStrategy, InitializingBean {
    /**
     * 抽象方法 处理表达式
     */
    @Override
    public String handleExpression(Condition condition) {
        ...
        return StrUtil.format("(expressionHandler.cascadeHandler(\"{}\",\"{}\",\"{}\",execution))", id, compare,
    ...
    public boolean handleResult(Condition condition, Map<String, Object> paramMap) {
        ...
        return bean.cascadeHandler(id,compare,value==null?null: EscapeUtil.escape(JsonUtil.toJSONString(value)),paramMap.get(id));
    }
